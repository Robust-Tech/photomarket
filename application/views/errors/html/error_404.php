...
<script src="https://ajax.googleapis.com/ajax/libs/webfont/1.6.16/webfont.js"></script>
	...
	<!-- ======= css ======= -->
	<link rel="stylesheet" href="<?=$url?>/assets/css/extra.css">
...
<div class="m-grid m-grid--hor m-grid--root m-page">
				...
				<div class="m-grid__item m-grid__item--fluid m-grid  m-error-5" style="background-image: url(<?=$url?>assets/images/404_bg.jpg);">
	...
	<script type="text/javascript" src=".<?=$url?>assets/js/extra.js"></script>
	<!-- ====== active js ======= -->
