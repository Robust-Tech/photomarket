...
<div class="jumbotron md index-header jumbotron_set jumbotron-cover">
      <div class="container wrap-jumbotron position-relative">
        <h1 class="title-site title-sm">Share your work and start earning</h1>
        <p class="subtitle-site"><strong><p class="subtitle-site"><strong>Join African Photostock community of contributors and earn money doing what you love.</strong></p></strong></p>
      </div>
    </div>
					...
					<div class="m-login__wrapper-1-1">
						<div class="m-login__contanier">
							<div class="m-login__content">
								...
								<p>You'll sell an industry-leading collection of world-class content. African photo stock has hundreds of millions of royalty-free images, vectors, illustrations, video clips, and music tracks with over 1M new assets added daily from over 400,000 contributors across the world. And all our content is 100% vetted for quality</p>
								<ul>
								    <li>You'll earn commission on every sale</li>
								    <li>Expand your business portfolio with a proven product</li>
								    <li>Our promotions and incentives help you sell more </li>
								    <li>You can take advantage of our marketplace and submit images for sale on African photostock.com</li>
								</ul>
								</div>
