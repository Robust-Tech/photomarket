...
<meta name="author" content="Big Bite Consulting" />
								...
								<div id="m_header_topbar" class="m-topbar  m-stack m-stack--ver m-stack--general">
									<div class="m-stack__item m-topbar__nav-wrapper">
                                        ...
                                        <li class="m-nav__item"  aria-haspopup="true">
											<a  href="<?=base_url('pricing')?>" class="m-nav__link ">
	...
	data-dropdown-toggle="click" data-dropdown-persistent="true" id="m_quicksearch" data-search-type="dropdown">
        ...
        {?>
                        ...
                        if(!User::is_admin()){?>
                                            ...
                                            <li  class="m-nav__item">
												<a href="<?=base_url()?>register" class="m-nav__link  btn btn-focus m--btn">
													<span class="m-nav__link-text">
														Sign up
													</span>
												</a>
    					 ...
    					 <?=config_item('website_name')?>
							...
							<div class="m-stack__item m-stack__item--right m-stack__item--middle m-stack__item--first">
								<ul class="m-footer__nav m-nav m-nav--inline m--pull-right">
									<li class="m-nav__item">
										<a href="<?=base_url()?>/about" class="m-nav__link">
											<span class="m-nav__link-text">
												About
											</span>
										</a>
									...
									<li class="m-nav__item">
										<a href="<?=base_url()?>/policy"  class="m-nav__link">
											<span class="m-nav__link-text">
												Privacy
											</span>
										</a>
									...
									<li class="m-nav__item">
										<a href="<?=base_url()?>/terms" class="m-nav__link">
											<span class="m-nav__link-text">
												T&C
											</span>
										</a>
    ...
    <script src="<?=base_url()?>themes/<?=config_item('theme')?>/assets/js/scripts.js"></script>
        ...
        {
                ?>
    <script src="<?=base_url()?>themes/<?=config_item('theme')?>/assets/js/dashboard.js"></script>
        <?php 
}
}
        ?>
