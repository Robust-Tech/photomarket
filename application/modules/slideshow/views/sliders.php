                ...
                <?php } ?> 
                                   ...
                                   <div class="form-group m-form__group row">
												...
												Title:
													...
													<input type="text" class="form-control m-input"  name="title" placeholder="Enter Slider Title">
												</div>
											</div> 
                                   <div class="form-group m-form__group row">
												<div class="col-lg-12">
		...
		var datatable = $('.m_datatable').mDatatable({
			...
			columns: [{
                ...
                template: function (row) {
					return '<img class="img-responsive img-thumbnail" src="<?=base_url()?>assets/sliders/' + row.picture + '">';
				}
			},{
				field: "title",
				title: "Title",
